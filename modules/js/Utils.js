...
function gotoPreviousForm(){
	...
	if(currentFormIndex >= 1){
		...
		var alert_seq0_act1 = kony.ui.Alert({"message" : "Unable to go ;kqt;BACK;kqt;. This is the starting page.....", "alertType" : constants.ALERT_TYPE_ERROR,"alertTitle": "Alert !!!!!", "yesLabel" : " OK ", "noLabel" : "", "alertIcon" : "icon.png", "alertHandler" : handle2}, {});
	}
}
	...
	if(resultset != null){
		...
		if(DBEvent == "ALLNOTES"){
			for ( var i = 0; i <= numResults - 1; i++ ){
				...
				var addItem = { selectedDate : rowItem.date.toString(), selectedSubject : rowItem.subject.toString() } ;
